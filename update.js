...
export default function update(view, upd) {
  ...
  if (upd.hasOwnProperty('$unset')) {
    ...
    if (typeof view !== 'object')
      throw new Error('view is not an object in unset');
  ...
  if (upd.hasOwnProperty('$merge')) {
    ...
    if (typeof view !== 'object')
      throw new Error('view is not an object in merge');
    if (typeof upd !== 'object')
      throw new Error('update is not an object in merge');
  ...
  if (upd.hasOwnProperty('$push')) {
    ...
    if (!Array.isArray(upd['$push']))
      throw new Error('update is not an array in push');
  ...
  if (upd.hasOwnProperty('$unshift')) {
    ...
    if (!Array.isArray(view))
      throw new Error('view is not an array in unshift');
    if (!Array.isArray(upd['$unshift']))
      throw new Error('update is not an array in unshift');
  ...
  if (upd.hasOwnProperty('$splice')) {
    ...
    if (!Array.isArray(upd['$splice']))
      throw new Error('update is not an array in splice');
  ...
  if (upd.hasOwnProperty('$apply')) {
    if (view === undefined || view === null) view = {};
    if (typeof upd['$apply'] !== 'function')
      throw new Error('update is not a function in apply');
    ...
    if (new_view === undefined)
      throw new Error('view is not an object, array or primitive');
